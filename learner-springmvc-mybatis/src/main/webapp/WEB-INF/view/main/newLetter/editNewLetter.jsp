      ...
      <div class="box">
       ...
       <div class="panel panel-default">
        ...
        <div class="panel-body">
           <form data-toggle="validator" role="form" id="submitform" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/newletter/editNew">
              <div class="form-group">
              <label style="font-size:18px;">新闻标题</label><br>
                 <input type="hidden" id="newId" name="newId" value="${newBean.newId}"/>
                <input type="text" class="form-control" id="newTitle" name="newTitle" maxLength="200"  placeholder="请输入新闻标题" required  value="${newBean.newTitle}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input size="16" type="text" id="pushTime" name="pushTime" class="form_datetime" required value="${newBean.pushTime}">
              </div>
              <div class="form-group" style="position:relative;">
                ...
                <span style="color:red;font-weight:bold;font-size:14px;">&nbsp;(* 请点击上传图片按钮进行图片上传操作)</span><br>
                  ...
                  <div id="result" style="width:100px;">
                      <img id="uploadImage" style="max-width:100%;width:100%;" src="${pageContext.request.contextPath}/${newBean.thumbnails}">
                  </div>
              ...
              <div class="form-group">
                 ...
                 <textarea id="newDetails"  name="newDetails" rows="10" cols="80" value="${newBean.newDetails}"></textarea>
              </div>
              <div class="form-group" style="text-align:center;">
                  <button type="submit" id="submitBut" class="btn btn-primary btn-lg" style="width:20%;" >提交</button>
                 <button type="button" id="backToNewLetter" class="btn btn-default btn-lg" style="width:20%;margin-left:10px;" >返回</button>
              </div>
           </form>
        </div>
      </div>
...
<script src="${ bower_components}/ckeditor/ckeditor.js"></script>
 ...
 <script type="text/javascript">
   $(function() {
       ...
       $("#backToNewLetter").bind('click',function(){
           window.location.href = '${pageContext.request.contextPath}/newletter/init';
       });
       var flowUpTop = '${newBean.flowUpTop}';
       var typeId = '${newBean.typeId}';
       $("#flowUpTop").val(flowUpTop);
       $("#typeId").val(typeId);
   });
